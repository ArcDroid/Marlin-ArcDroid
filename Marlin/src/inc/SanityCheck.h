 ...
 */
  ...
  #if IS_KINEMATIC && !ENABLED(MORGAN_SCARA)
    #error "MIN_SOFTWARE_ENDSTOPS on DELTA/SCARA also requires MIN_SOFTWARE_ENDSTOP_Z."
  #elif NONE(MIN_SOFTWARE_ENDSTOP_X, MIN_SOFTWARE_ENDSTOP_Y, IGNORE_SOFTWARE_ENDSTOP_Z)
  ...
  #elif NONE(MAX_SOFTWARE_ENDSTOP_X, MAX_SOFTWARE_ENDSTOP_Y, IGNORE_SOFTWARE_ENDSTOP_Z)
