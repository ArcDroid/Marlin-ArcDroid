...
#undef _STOP_IN_USE
  ...
  #define Z_MIN_PIN          -1
#endif
#if !HAS_X2_MIN && (DISABLED(X_DUAL_ENDSTOPS) || X_HOME_TO_MAX)
  #undef X2_MIN_PIN
#endif
#if !HAS_X2_MAX && (DISABLED(X_DUAL_ENDSTOPS) || X_HOME_TO_MIN)
  #undef X2_MAX_PIN
#endif
#if !HAS_Y2_MIN && (DISABLED(Y_DUAL_ENDSTOPS) || Y_HOME_TO_MAX)
  #undef Y2_MIN_PIN
#endif
#if !HAS_Y2_MAX && (DISABLED(Y_DUAL_ENDSTOPS) || Y_HOME_TO_MIN)
  #undef Y2_MAX_PIN
#endif
