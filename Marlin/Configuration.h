...
//#define MP_SCARA
  ...
  #define SCARA_OFFSET_Y  -290.0       // (mm)
    ...
    #define THETA_HOMING_OFFSET  0.0  // Calculated from Calibration Guide and M360 / M114. See http://reprap.harleystudio.co.za/?page_id=1073
    #define PSI_HOMING_OFFSET    0.0  // Calculated from Calibration Guide and M364 / M114. See http://reprap.harleystudio.co.za/?page_id=1073
...
/**
 * Use encoder sled to position machine on bigger work area
 */
#define ENCODER_SLED
...
#define FORCE_UPDATE_ENDSTOPS_INTERRUPT
...
#else
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 442.38, 442.38, 200, 1000 }  // default steps per unit for SCARA
#endif
...
// Z_MIN_POS
#define Z_PROBE_LOW_POINT          -300 // Farthest distance below the trigger-point to go before stopping
...
#define NO_RAISE_PROBE  // Don't ever raise Z before probing
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  #define IGNORE_SOFTWARE_ENDSTOP_Z
#endif
